...
class DatasetBankAdditional(AbstractDataset):
    def __init__(self):
        super().__init__()
    ...
    def load(self):
        ...
        data = pd.read_csv("/Users/andreyageev/PycharmProjects/NAF/dataset_folder/bank-additional-full_normalised.csv")

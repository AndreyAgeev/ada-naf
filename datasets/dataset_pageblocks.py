...
class DatasetPageBlocks(AbstractDataset):
    def __init__(self):
        super().__init__()

    def load(self):
        """From DIF"""
        data = pd.read_csv("/Users/andreyageev/PycharmProjects/NAF/dataset_folder/pageblocks_16.csv")
        data = data.astype(float)
        fraud_data = data[data['label'] == 1].iloc[0:50]
        norm_data = data[data['label'] == 0].iloc[0:500]
